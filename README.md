...
- **Tools & Frameworks**: Tkinter, SQLite, Git  
- **Cybersecurity**: Vulnerability Assessment, Web Security, Penetration Testing  
...
- 🏥 **Hospital Management System**  
  Developed a desktop application using Tkinter & SQLite to manage patient records and appointments.  
  Features: CRUD operations, user authentication, enhanced UI for ease of use.  
...
- 💻 C Programming – NPTEL  
- 🔐 Ethical Hacking (Ongoing) – Hyderabad Hacker Academy  

---

### 📫 Let's Connect!  

- [LinkedIn](https://www.linkedin.com/in/ranjith-gowda-88b788322)  
- [GitHub](https://github.com/ranjith0115)  
- 📧 Email: gowdaranjith969@gmail.com  
- 📱 +91 7892591612  
